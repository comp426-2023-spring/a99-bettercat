      ...
      <div className="flex flex-col bg-slate-300 min-h-screen p-10 space-y-5">
        ...
        <div className="self-center">
          {dbUser && favorited ? (
            ...
            <a className="inline-flex items-center justify-center  px-5 py-3 mr-1 text-base font-medium text-center text-white bg-slate-400 rounded-lg hover:bg-slate-500 focus:ring-4 focus:ring-slate-300 dark:focus:ring-slate-900">
              Loading...
              <svg
                className="w-5 h-5 ml-2 -mr-1"
                fill="currentColor"
          ...
          <a className="inline-flex items-center justify-center  px-5 py-3 ml-1 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
            Website
            <svg
              className="w-5 h-5 ml-2 -mr-1"
              fill="currentColor"
